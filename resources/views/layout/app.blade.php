...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#"><i
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <!-- footer -->
                <footer class="py-3 navbar-desktop border-top border-body" data-bs-theme="dark">
                    <p class="text-center">© 2024 RAWP</p>
                </footer>
            </main>
        </div>
    </div>
    ...
    <!-- Additional scripts for DataTables buttons -->
